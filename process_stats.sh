...
ncpdq --permut time,ensemble,scenario,lat,lon temp.nc temp2.nc
    ...
    #  outfile=${outdir}/LOCAL_CHEYENNE_THORTHWAITE_${PERIOD_STRING}.nc
     ...
     ncks -d time,'1970-01-01 00:00:00.0','1999-12-31 00:00:00.0' ./LOCAL_TREWARTHA_ALL_ENSEMBLES.nc ./30-yr/LOCAL_THORNTHWAITE_ALL_ENSEMBLES_1970-1999.nc
     ncks -d time,'2011-01-01 00:00:00.0','2040-12-31 00:00:00.0' ./LOCAL_TREWARTHA_ALL_ENSEMBLES.nc ./30-yr/LOCAL_THORNTHWAITE_ALL_ENSEMBLES_2011-2040.nc
     ncks -d time,'2061-01-01 00:00:00.0','2090-12-31 00:00:00.0' ./LOCAL_TREWARTHA_ALL_ENSEMBLES.nc ./30-yr/LOCAL_THORNTHWAITE_ALL_ENSEMBLES_2061-2090.nc
